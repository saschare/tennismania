 ...
 */
class Moraso_Plugin_Revisionprogression_Article_Controller extends Moraso_Adm_Plugin_Controller {
    ...
    public function indexAction() {
        ...
        $this->view->idartlang = Moraso_Util::getIdArtLang($this->view->idart, AItsu_Registry::get()->session->currentLanguage);
    }
