 ...
 */
class Aitsu_Plugin_Redirector_Article_Controller extends Moraso_Adm_Plugin_Controller {
    ...
    public function indexAction() {
        ...
        $form = Aitsu_Forms::factory(strtolower($classExplode[2]), APPLICATION_LIBPATH . '/' . $classExplode[0] . '/' . $classExplode[1] . '/' . $classExplode[2] . '/' . $classExplode[3] . '/forms/redirector.ini');
        $form->title = Aitsu_Translate :: translate('Redirection');
        $form->url = $this->view->url(array('namespace' => 'aitsu', 'plugin' => 'redirector', 'area' => 'article', 'paction' => 'index'), 'plugin');
